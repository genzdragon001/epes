...
$periods = [];
$rp_qry = $conn->query("SELECT DISTINCT rating_period FROM ratings WHERE rating_period != '' AND (efficiency > 0 OR timeliness > 0 OR quality > 0) ORDER BY rating_period DESC");
