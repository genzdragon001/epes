				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<?php if(isset($id) && isset($isBlocked) && $isBlocked == 1): ?>
							<div class="form-group">
								<button type="button" class="btn btn-warning btn-sm" id="reset_evaluator">Unblock & Reset Failed Login</button>
							</div>
						<?php endif; ?>
					</div>
				</div>
